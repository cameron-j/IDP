...
static MapState prev_state;
static MapState next_state;

static unsigned char node_count;

// Start, dropoffs, blocks then junctions
static MapNode nodes[N_NODES];
...
void connect_map_nodes(unsigned char n1_idx, unsigned char n2_idx, unsigned int dist, char dir12, char dir21);
void setup_map();
